...
namespace OpenBanking_API_Service.Migrations
{
    ...
    [Migration("20240101151651_ModifiedBankAccountDepositDetails")]
    partial class ModifiedBankAccountDepositDetails
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "cb96eb18-646c-47d3-98c1-be8d126a35ba",
                            ConcurrencyStamp = "1",
                            Name = "Admin",
                        ...
                        new
                        {
                            Id = "cb6c801e-cfd1-481d-bdd0-912c9a97244f",
                            ConcurrencyStamp = "2",
                            Name = "User",
                            NormalizedName = "USER"
                        });
            ...
            modelBuilder.Entity("OpenBanking_API_Service_Common.Library.Entities.Account.BankAccount", b =>
                {
            ...
            modelBuilder.Entity("OpenBanking_API_Service_Common.Library.Entities.Account.BankAccount", b =>
                {
                    b.HasOne("OpenBanking_API_Service.Data.ApplicationUser", "User")
                        .WithOne("BankAccount")
                        .HasForeignKey("OpenBanking_API_Service_Common.Library.Entities.Account.BankAccount", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
